        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <h2 className="font-serif text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Michael Chang</h2>
              <p className="text-xl font-medium text-primary">Founder & CEO, Chang Financials</p>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  With over two decades of experience in financial services, Michael Chang has established himself as a
                  trusted advisor to individuals and businesses seeking to achieve their financial goals.
                </p>
                <p>
                  After graduating from Harvard Business School and spending 10 years at leading financial institutions,
                  Michael founded Chang Financials with a vision to provide personalized, comprehensive financial
                  solutions that put clients first.
                </p>
                <p>
